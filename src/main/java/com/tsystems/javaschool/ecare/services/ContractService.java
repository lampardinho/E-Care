...
public class ContractService
{
     ...
     * and DAO returns null.
     */
    public Contract loadContract(int id) throws ECareException
    {
     ...
     * in the database.
     */
    public Contract getContractByPhoneNumber(int number) throws ECareException {
     ...
     */
    public void deleteContract(int id) throws ECareException {
     ...
     * and DAO returns null.
     */
    public List<Contract> getUserContracts(User user) throws ECareException {
